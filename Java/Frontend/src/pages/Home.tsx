      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            Configure Your
            <span className="text-transparent bg-gradient-accent bg-clip-text"> Dream Vehicle</span>
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-2xl mx-auto">
            Professional vehicle configuration system for automotive dealers and customers
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="automotive" size="lg" onClick={() => navigate('/configure')} className="text-lg px-8 py-6 transition-all duration-300 border border-transparent hover:border-white/50">
            Start Configuring</Button>

            <Button variant="destructive" size="lg" onClick={handleRegistration} className="text-lg px-8 py-6">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our comprehensive system provides everything you need for professional vehicle configuration, 
              from selection to invoice generation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="shadow-card hover:shadow-automotive transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Choose from multiple segments, manufacturers, and models with detailed specifications.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card hover:shadow-automotive transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Configure interior, exterior, and standard features with real-time pricing updates.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card hover:shadow-automotive transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Generate professional invoices with detailed pricing and tax calculations.
                </p>
              </CardContent>
            </Card>
...
<section className="py-24 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155] text-white">
  <div className="container mx-auto px-6 text-center">
    <h2 className="text-5xl font-extrabold mb-6 tracking-tight">Ready to Get Started?</h2>
    <p className="text-xl mb-10 text-white/80 max-w-2xl mx-auto">
      Join automotive dealers worldwide who trust our vehicle configuration platform.
    </p>
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      <Button
        size="lg"
